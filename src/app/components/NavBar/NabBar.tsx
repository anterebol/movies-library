...
export function Navbar() {
  ...
  return (
    <>
      ...
      <Button className={classes.side__bar__burger} onClick={() => {
        toggleMenu(opened)
      }}>
          <Image width={25} height={20} src={burgerMenu} title='Toggle meny' alt='open_button' />
        </Button>
    </div>
      <nav className={navBarClassName}>
      <Logo />
      <Button className={classes.navbar__close__burger} onClick={() => {
        toggleMenu(opened)
      }}>
          <Image width={20} height={20} src={closeBurger} title='Toggle meny' alt='open_button' />
        </Button>
